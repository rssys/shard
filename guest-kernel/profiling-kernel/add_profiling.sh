...
cp ${SHARD_PATH}/guest-kernel/profiling-kernel/kernel-linked-bcs.o.bc ${SHARD_PATH}/guest-kernel/instrumentation/cfi/.

cd ${SHARD_PATH}/guest-kernel/instrumentation/cfi
./build_and_run.sh kernel-linked-bcs.o
cp kernel-linked-bcs.o-instrumented.bc ${SHARD_PATH}/guest-kernel/profiling-kernel/.
echo "[*] CFI instrumentation applied!"

cp ${SHARD_PATH}/guest-kernel/profiling-kernel/kernel-linked-bcs.o-instrumented.bc ${SHARD_PATH}/guest-kernel/instrumentation/specialization/kernel-linked-bcs.o.bc
...
cp ${SHARD_PATH}/guest-kernel/profiling-kernel/kernel-linked-bcs.o-instrumented.bc ${SHARD_PATH}/guest-kernel/instrumentation/shadowstack/kernel-linked-bcs.o.bc
...
cp ${SHARD_PATH}/guest-kernel/profiling-kernel/kernel-linked-bcs.o-instrumented.bc ${SHARD_PATH}/guest-kernel/instrumentation/padding/kernel-linked-bcs.o.bc
...
cp vmlinux ${SHARD_PATH}/guest-kernel/profiling-kernel/.
cd ${SHARD_PATH}/guest-kernel/profiling-kernel/
